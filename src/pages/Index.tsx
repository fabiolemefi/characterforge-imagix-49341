              ...
              <section className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div className="bg-[#1A1A1A] rounded-lg p-4 flex items-start">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <h3 className="font-medium text-white">Criador de Slides</h3>
                  ...
                  <div className="bg-[#1A1A1A] rounded-lg p-4 flex items-start">
                    ...
                    <div>
                      <h3 className="font-medium text-white">Criador de Emails</h3>
                      <p className="text-sm text-gray-400 mt-1">Crie e envie para o SFMC</p>
                    </div>
                  </div>
