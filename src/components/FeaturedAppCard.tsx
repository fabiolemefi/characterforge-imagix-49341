...
export const FeaturedAppCard = ({
  ...
  return <div className={`feature-card bg-muted rounded-lg overflow-hidden flex flex-col ${inDevelopment ? "opacity-50" : ""}`}>
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-4 flex justify-end">
          <Button onClick={handleClick} disabled={inDevelopment} className="text-white px-4 py-1.5 rounded-md flex items-center justify-center gap-1.5 font-medium disabled:opacity-50 disabled:cursor-not-allowed text-sm bg-cyan-600 hover:bg-cyan-500">
